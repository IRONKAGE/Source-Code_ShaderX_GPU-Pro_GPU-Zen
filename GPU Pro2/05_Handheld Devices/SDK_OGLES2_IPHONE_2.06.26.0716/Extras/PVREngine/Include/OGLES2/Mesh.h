...
namespace pvrengine
{
	...
	const CPVRTString g_strDrawModeNames[eNumDrawModes]= {
		"Normal",
			"No FX",
			"Wireframe",
	...
	*****************************************************************************/
	...
	public:
		...
		*****************************************************************************/
		Mesh(CPVRTModelPOD *psScene, const int iIndex, MaterialManager *pMaterialManager);
		...
		*****************************************************************************/
		bool setDrawMode(const EDrawMode eDrawMode);

		/*!***************************************************************************
		@Function			getDrawMode
		@Description		Gets the draw mode for this mesh
		*****************************************************************************/
		EDrawMode getDrawMode() const	{return m_eDrawMode;}
		...
		*****************************************************************************/
		...
		@Description		Gets the Material for this mesh
		*****************************************************************************/
		...
		*****************************************************************************/
		CPVRTString getDrawModeName(const EDrawMode eDrawMode) const;
	...
	private:
		...
		EDrawMode			m_eDrawMode;					/*! Render mode for this Mesh */
