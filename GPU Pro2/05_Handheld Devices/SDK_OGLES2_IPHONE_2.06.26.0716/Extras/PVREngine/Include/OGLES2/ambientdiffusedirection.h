/******************************************************************************
 ...
 @File         ambientdiffusedirection.h
...
#ifndef _AMBIENT_DIFFUSE_DIRECTION_H_
#define _AMBIENT_DIFFUSE_DIRECTION_H_

const char ambdiffdirectionshader[] =
"[HEADER]\n"
"	VERSION		01.00.00.00\n"
...
"	UNIFORM	myLightDirection	LIGHTDIRWORLD\n"
...
"			Normal = normalize(myWorldIT * myNormal);\n"
"			lowp float litFactor = dot(Normal, normalize(myLightDirection));\n"
