...
/*!***************************************************************************
* @Class PVRES
* @Brief 	A simple script class for use with PODPlayer.
* @Description 	A simple script class for use with PODPlayer.
*****************************************************************************/
class PVRES
{
public:
	...
	*****************************************************************************/
	...
	@Input				bDefaultLight a default light or not
	@Description		sets whether a default light is required or not
	*****************************************************************************/
	void setDefaultLight(const bool bDefaultLight)
	{m_bDefaultLight = bDefaultLight;}

	/*!***************************************************************************
	@Function			getDefaultLight
	@Description		gets whether a default light is required or not
	@Return				whether a default light is wanted or not
	*****************************************************************************/
	bool getDefaultLight() const
	{return m_bDefaultLight;}

	/*!***************************************************************************
	@Function			setFrustumCull
	@Input				bFrustumCull frustum cull or not
	@Description		sets whether to frustum cull or not
	*****************************************************************************/
	void setFrustumCull(const bool bFrustumCull)
	{m_bFrustumCull = bFrustumCull;}

	/*!***************************************************************************
	@Function			getFrustumCull
	@Description		gets whether PODPlayer will use frustum culling or not
	@Return				whether PODPlayer will use frustum culling or not
	*****************************************************************************/
	bool getFrustumCull() const
	{return m_bFrustumCull;}
	...
	*****************************************************************************/
	...
	{
		if(i32DrawMode>0 && i32DrawMode<pvrengine::eNumDrawModes)
...
protected:
	...
	bool m_bFullScreen,m_bShowFPS,m_bVertSync,m_bLogToFile,m_bPowerSaving,m_bDefaultLight,m_bFrustumCull;
