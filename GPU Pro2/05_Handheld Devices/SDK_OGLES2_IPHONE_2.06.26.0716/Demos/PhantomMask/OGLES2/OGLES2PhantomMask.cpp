...
public:
	...
	OGLES2PhantomMask() : m_bEnableSH(true),
						  m_ui32TimePrev(0),
						  m_fFrame(0.0f)
	{
	}
...
bool OGLES2PhantomMask::InitApplication()
{
	...
	m_ui32TimePrev = PVRShellGetTime();
...
bool OGLES2PhantomMask::RenderScene()
{
	...
	*/
	...
	if(iTime > m_ui32TimePrev)
	{
		int iDeltaTime = iTime - m_ui32TimePrev;
	...
	*/
	...
	{
		// Shadow
		m_Print3D.Print3D(0.0f, 8.0f, 0.905f,  PVRTRGBA(0,0,0,255), "Spherical Harmonics Lighting");
	...
	{
		// Shadow
		m_Print3D.Print3D(0.0f, 8.0f, 0.905f,  PVRTRGBA(0,0,0,255), "Vertex Lighting");
