...
Basetex.pvr: $(MEDIAPATH)/Base.png
	$(PVRTEXTOOL) -m -nt -fOGL565 -i$(MEDIAPATH)/Base.png -o$@

Reflection.pvr: $(MEDIAPATH)/Reflection.png
	$(PVRTEXTOOL) -m -nt -fOGL565 -i$(MEDIAPATH)/Reflection.png -o$@

Cubemap.pvr: $(MEDIAPATH)/cubemap1.png $(MEDIAPATH)/cubemap2.png $(MEDIAPATH)/cubemap3.png $(MEDIAPATH)/cubemap4.png $(MEDIAPATH)/cubemap5.png $(MEDIAPATH)/cubemap6.png
	$(PVRTEXTOOL) -s -m -fOGLPVRTC4 -i$(MEDIAPATH)/cubemap1.png -o$@

AnisoMap.pvr: $(MEDIAPATH)/anisotropicmap.png
	$(PVRTEXTOOL) -m -nt -fOGL565 -i$(MEDIAPATH)/anisotropicmap.png -o$@
