...
bool OGLES2FilmTV::LoadShaders(CPVRTString* pErrorStr)
{
	...
	*/
	...
	// Store the location of uniforms for later use
	m_BWShaderProgram.uiMVPMatrixLoc= glGetUniformLocation(m_ShaderProgram.uiId, "MVPMatrix");
	m_BWShaderProgram.uiLightPosLoc	= glGetUniformLocation(m_ShaderProgram.uiId, "LightPosition");
