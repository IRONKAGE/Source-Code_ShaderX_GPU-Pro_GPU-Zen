...
Lattice.pvr: $(MEDIAPATH)/cylinder.png $(MEDIAPATH)/cylindera.png
	$(PVRTEXTOOL) -nt -fOGL8888 -i$(MEDIAPATH)/cylinder.png -a$(MEDIAPATH)/cylindera.png -o$@

Stone.pvr: $(MEDIAPATH)/stone.png
	$(PVRTEXTOOL) -m -nt -fOGL8888 -i$(MEDIAPATH)/stone.png -o$@

Tile.pvr: $(MEDIAPATH)/tile.png
	$(PVRTEXTOOL) -m -nt -fOGL8888 -i$(MEDIAPATH)/tile.png -o$@
