	...
	* @Description Manages contexts predominantly for extensions.
	...
	public:
		...
		*****************************************************************************/
		...
		@Return				pointer to the SPVRTContext
		@Description		Allows access to the OpenGL ES2 SPVRTContext class for the
							current context.
		*****************************************************************************/
		...
		*****************************************************************************/
		int addNewContext(SPVRTContext *pContext);
		...
		*****************************************************************************/
		void setCurrentContext(const int i32Context);
	private:
		/****************************************************************************
		** Variables
		****************************************************************************/
		/*! the list of contexts */
		dynamicPointerArray<SPVRTContext> m_daContext;
