...
bool OGLES2Skinning::RenderScene()
{
	...
	*/
	...
	m_Print3D.DisplayDefaultTitle("Skinning", "", ePVRTPrint3DLogoIMG);
	m_Print3D.Flush();
...
void OGLES2Skinning::DrawMesh(int i32NodeIndex)
{
	...
	glVertexAttribPointer(BONEWEIGHT_ARRAY, Mesh.sBoneWeight.n, GL_FLOAT, GL_FALSE, Mesh.sBoneWeight.nStride, Mesh.sBoneWeight.pData);
