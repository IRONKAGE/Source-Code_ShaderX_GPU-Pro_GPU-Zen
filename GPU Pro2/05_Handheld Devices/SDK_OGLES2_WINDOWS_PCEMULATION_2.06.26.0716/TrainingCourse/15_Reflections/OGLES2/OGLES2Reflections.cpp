...
char* g_MappingList[] = {"2D Mapping", "Cube Mapping"};
...
bool OGLES2Reflections::RenderScene()
{
	...
	*/
	...
	m_Print3D.DisplayDefaultTitle("Reflections", "", ePVRTPrint3DLogoIMG);
	m_Print3D.Print3D(0.3f, 7.5f, 0.75f, PVRTRGBA(255,255,255,255), "Reflection: %s", g_MappingList[m_bCubeReflection]);
	m_Print3D.Flush();
