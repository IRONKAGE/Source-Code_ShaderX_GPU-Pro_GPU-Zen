...
Reflection.pvr: $(MEDIAPATH)/ReflectionMap.png
	$(PVRTEXTOOL) -m -fOGLPVRTC4 -i$(MEDIAPATH)/ReflectionMap.png -o$@

Thickness.pvr: $(MEDIAPATH)/ThicknessMap.png
	$(PVRTEXTOOL) -m -nt -fOGL8 -i$(MEDIAPATH)/ThicknessMap.png -o$@

$(CONTENTDIR)/Reflection.cpp: Reflection.pvr
	$(FILEWRAP)  -o $@ Reflection.pvr

$(CONTENTDIR)/Thickness.cpp: Thickness.pvr
